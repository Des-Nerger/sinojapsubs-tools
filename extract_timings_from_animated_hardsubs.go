...
/*
	...
	$ ffmpeg -y -v quiet -i "$B".??[!ast] -map 0:v -filter:v "crop=486:82:79:357" -f rawvideo -pix_fmt yuv444p - | go run "$T"/extract_timings_from_animated_hardsubs.go -bgYuvRange __85739c78a4 -fgYuvRanges 9f__7d__7d -frameSize 119556 "$B".srt

	$ ffmpeg -y -v quiet -ss 00:35:12 -i "$B".??[!ast] -map 0:v -filter:v "crop=486:82:79:357" -f rawvideo -pix_fmt yuv444p - | go run "$T"/extract_timings_from_animated_hardsubs.go -bgYuvRange __85739c78a4 -fgYuvRanges 9f__7d__7d -frameSize 119556 /dev/null | avplay -loglevel quiet -f rawvideo -pixel_format yuv444p -video_size 486x82 - >/dev/null
*/
